...
console.log(canWeDeliver(30152))
console.log(canWeDeliver(85213))
console.log(canWeDeliverTwo(30152))
...
const newDeal = deals.map((element,index,arr) => {
    return {...element, title: element.title.replace('15','10')}})

console.log(newDeal)

//// this took forever. I had an if statement in there. and for whatever reason i couldn't get it to work.
//I analyzed the heck out of why it wasn't working with the if statement. Couldn't get to the bottom of it.
/*
...
const secondDeal = newDeal.map(element => {
    return {...element, desc: element.desc.replace(`March`,`April`).trim()
}})

// this was a little easier after I just copied and pasted the one above.  I had a little trouble with where to put the trim.
// but with trial and error was able to get it right.
